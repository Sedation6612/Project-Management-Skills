...
- [INFO_RESEARCH.md](INFO_RESEARCH.md) — Research notes and constraints for AI engineering guidance.
- [LOG_CACHES.md](LOG_CACHES.md) — Index for separated log files.
- [LOG_PROJECTS.md](LOG_PROJECTS.md) — Project registry and active focus.
- [LOG_CHARTERS.md](LOG_CHARTERS.md) — Charter records.
- [LOG_CONFLICTS.md](LOG_CONFLICTS.md) — Conflicts and gate checklist.
- [LOG_DECISIONS.md](LOG_DECISIONS.md) — Decision history.
- [LOG_ACTIVITY.md](LOG_ACTIVITY.md) — Detailed activity log.
